...
(function (global, factory) {
  ...
  var Tokenizer_1 = /*#__PURE__*/function () {
    ...
    _proto.strong = function strong(src, params) {
      var _ref = [params.prevChar, params.maskedSrc],
          prevChar = _ref[0],
          maskedSrc = _ref[1];
    ...
    _proto.em = function em(src, params) {
      var _ref2 = [params.prevChar, params.maskedSrc],
          prevChar = _ref2[0],
          maskedSrc = _ref2[1];
    ...
    _proto.autolink = function autolink(src, params) {
      ...
      if (cap) {
        ...
        if (cap[2] === '@') {
          text = _escape(this.options.mangle ? params.mangle(cap[1]) : cap[1]);
          href = 'mailto:' + text;
        } else {
          text = _escape(cap[1]);
          href = text;
  ...
  var Lexer_1 = (_temp = /*#__PURE__*/function () {
    function Lexer(options) {
      _defineProperty(this, "inlineText", function (src, params) {
        var token;
      ...
      this.blockTokenizers = [{
        name: 'newline',
        func: this.tokenizer.space.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'code',
        func: this.tokenizer.code.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'fences',
        func: this.tokenizer.fences.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'nptable',
        func: this.tokenizer.nptable.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'heading',
        func: this.tokenizer.heading.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'hr',
        func: this.tokenizer.hr.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'blockquote',
        func: this.blockquote.bind(this),
        context: this
      }, {
        name: 'list',
        ...
        name: 'html',
        func: this.tokenizer.html.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'def',
        func: this.def.bind(this),
        context: this
      }, {
        name: 'table',
        func: this.tokenizer.table.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'lheading',
        func: this.tokenizer.lheading.bind(this.tokenizer),
        context: this.tokenizer
      }, {
        name: 'paragraph',
        func: this.paragraph.bind(this),
        context: this
      }, {
        name: 'text',
        func: this.tokenizer.text.bind(this.tokenizer),
        context: this.tokenizer
      }];
      this.inlineTokenizers = [{
        name: 'escape',
        func: this.tokenizer.escape,
        context: this.tokenizer
      }, {
        name: 'tag',
        func: this.tag,
        ...
        name: 'codespan',
        func: this.tokenizer.codespan,
        context: this.tokenizer
      }, {
        name: 'br',
        func: this.tokenizer.br,
        context: this.tokenizer
      }, {
        name: 'del',
        func: this.tokenizer.del,
        context: this.tokenizer
      }, {
        name: 'autolink',
        func: this.tokenizer.autolink,
        context: this.tokenizer
      }, {
        name: 'url',
        func: this.url,
    ...
    _proto.blockTokens = function blockTokens(src, tokens, top) {
      ...
      while (src) {
        if (this.blockTokenizers.some(function (fn) {
          return token = fn.func(src, blockParams);
        })) {
    ...
    _proto.inlineTokens = function inlineTokens(src, tokens, inLink, inRawBlock) {
      ...
      while (src) {
        ...
        if (this.inlineTokenizers.some(function (fn) {
          return token = fn.func.call(fn.context, src, inlineParams);
        })) {
          src = src.substring(token.raw.length); // if(token.tokens && !token.tokens.length) {
